...
@Autonomous(name = "Left - 3 Samples (1 from Start)")
public class LeftSamplesUlt extends AutonomousRobot {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive
                        ...
                        .stopAndAdd(new SamplePickupAction(armMotor, rotaMotor, clawServo, clawRota, claw360, RobotConstants.ARM_STRAIGHT_SAMPLE_PICK_UP_HEIGHT - 750))
                        .waitSeconds((0.0))
                        .turn(Math.toRadians(-25))
                        .strafeTo(new Vector2d(8, 59))
                        .waitSeconds((0.0))
